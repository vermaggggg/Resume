  ...
  return (
    ...
    <Fragment>
        <Row className="justify-content-center">
            <Col md={8} sm={12} className="d-flex justify-content-between img-column top_sec">
        ...
        <Row className="justify-content-center mt-2">
            <Col md={4} sm={6}>
                <Col>
                    <h4 className='your_name'>{profile.name}</h4>
                </Col>
                <Col className="d-flex justify-content-start">
                    <HiLocationMarker size={30} className="p-1 location"/><p className="p-1 m-0 text_color">{profile.location}</p>
            ...
            <Col md={4} sm={6} className="d-flex flex-wrap align-items-center">
                <p className="p-1 m-0 text_color" onClick={()=>handleAlertShow("LinkedIn Profile",profile.linkedin)}><BsLinkedin size={25} className="p-1 location"/>LinkedIn</p>
                <p className="p-1 m-0 text_color" onClick={()=>handleAlertShow("GitHub Profile",profile.github)}><BsGithub size={25} className="p-1 location"/>GitHub</p>
                <p className="p-1 m-0 text_color" onClick={()=>handleAlertShow("Portfolio",profile.website)}><BsGlobe size={25} className="p-1 location"/>Portfolio</p>
                <p className="p-1 m-0 text_color" onClick={()=>handleAlertShow("Email Address",profile.email)}><HiOutlineMail size={25} className="p-1 location"/>Email</p>
                <p className="p-1 m-0 text_color" onClick={()=>handleAlertShow("Contact Number",profile.contact)}><HiPhone size={25} className="p-1 location"/>Contact Number</p>
            </Col>
            ...
            <Modal.Body>
                <Form>
                    ...
                    <Form.Group controlId="formFileSm" className="mb-3">
                        <Form.Label className='text_color'>Profile Picture</Form.Label>
