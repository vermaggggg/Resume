        ...
        <Modal.Body>
          <Form noValidate validated={validated} onSubmit={handleSubmit}>
            <Form.Group className="mb-3">
              <Form.Label className='text_color'>School / College</Form.Label>
            ...
            <Form.Group className="mb-3">
              <Form.Label className='text_color'>Degree</Form.Label>
            ...
            <Form.Group className="mb-3">
              <Form.Label className='text_color'>Field of study</Form.Label>
            ...
            <Form.Group className="mb-3">
              <Row>
                <Col>
                  <Row>
                    <Form.Label className='text_color'>Start - Year</Form.Label>
                  </Row>
                  <Row>
                    <Col>
                ...
                <Col>
                  <Row>
                    ...
                    <Col>
                      <Row>
                        <Form.Label className='text_color'>End - Year</Form.Label>
                      </Row>
                      <Row>
                        <Col>
            ...
            <Form.Group className="mb-3">
              <Form.Label className='text_color'>Grade</Form.Label>
